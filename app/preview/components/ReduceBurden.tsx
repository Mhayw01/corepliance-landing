  ...
  return (
    <section className="bg-[var(--brand-grey-blue)]">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="flex items-center justify-center px-6 py-16 md:px-12 md:py-24 lg:order-2 lg:justify-start lg:pr-16 lg:pl-20">
        ...
        <div className="relative min-h-[320px] md:min-h-[480px] lg:order-1 lg:min-h-[560px]">
          <Image
